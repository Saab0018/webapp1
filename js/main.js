...
function init(ev) {
  let firstBtn = document.querySelector(".btn a:nth-child(1)");
  let secondBtn = document.querySelector(".btn a:nth-child(2)");
  let thirdBtn = document.querySelector(".btn a:nth-child(3)");

  let hammer1 = new Hammer(firstBtn);
  let hammer2 = new Hammer(secondBtn);
  let hammer3 = new Hammer(thirdBtn);
